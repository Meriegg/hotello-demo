...
All prices are in USD ($)`;
      ...
      const parsedData = JSON.parse(completionMessage ?? "null") as { yourResponse: string, chosenRoom: { id: string } };
